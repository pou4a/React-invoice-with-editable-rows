    ...
    return (
        <div className="print:hidden" {...getRootProps()}>
            ...
            {isDragActive ? (
                <button
                    type="button"
                    className="relative mt-2 block w-full border-2 border-gray-300 border-dashed rounded-lg p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800"
                >
